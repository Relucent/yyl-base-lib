...
public class StringUtil {
	...
	/**
	 * 判断字符序列是否以指定前缀开头<br>
	 * 自动处理null值不会抛出异常。两个null视为相等，区分大小写匹配<br>
	 *
	 * <pre>
	 ...
	 * @param str    需要校验的字符序列，允许为null
	 * @param prefix 待匹配的前缀字符串，允许为null
	 * @return 若字符序列以前缀开头（区分大小写），或两者都为null则返回true；否则返回false
	 */
	...
	/**
	 * 忽略大小写判断字符序列是否以指定前缀开头<br>
	 * 自动处理null值不会抛出异常。两个null视为相等，匹配时忽略字母大小写 <br>
	 * 
	 * <pre>
	 ...
	 * @param str    需要校验的字符序列，允许为null
	 * @param prefix 待匹配的前缀字符串，允许为null
	 * @return 若字符序列以前缀开头（忽略大小写），或两者都为null则返回true；否则返回false
	 */
	...
	/**
	 * 判断字符序列是否以指定前缀开头，可配置是否忽略大小写<<br>
	 *
	 * @see java.lang.String#startsWith(String)
	 * @param str        需要校验的字符序列，允许为null
	 * @param prefix     待匹配的前缀字符串，允许为null
	 * @param ignoreCase true=忽略大小写比较，false=区分大小写比较
	 * @return 若字符序列以前缀开头，或两者都为null则返回true
	 */
	private static boolean startsWith(final CharSequence str, final CharSequence prefix, final boolean ignoreCase) {
		if (str == null || prefix == null) {
			return str == prefix;
		}
		// 仅获取一次长度，避免极端场景下长度动态变化重复取值
	 ...
	 * </pre>
	 *
	 * @param sequence      待校验的字符序列，允许为null
	 * @param searchStrings 多个待匹配前缀，区分大小写；数组可为空，内部元素允许为null
	 * @see StringUtils#startsWith(CharSequence, CharSequence)
	 * @return 仅当传入字符串为null且无前缀数组时返回true；或字符串匹配任意一个前缀返回true；其余情况返回false
	 */
	...
	/**
	 * 判断字符序列是否以指定后缀结尾<br>
	 * 自动处理null值，不会抛出异常。两个null视为相等，匹配区分大小写<br>
	 *
	 * <pre>
	 ...
	 * @param str    需要校验的字符序列，允许为null
	 * @param suffix 待匹配的后缀字符串，允许为null
	 * @return 字符序列以后缀结尾（区分大小写），或两者都为null时返回true，否则返回false
	 */
	...
	/**
	 * 忽略大小写判断字符序列是否以指定后缀结尾<br>
	 *
	 * 自动处理null值，不会抛出异常。两个null视为相等，匹配忽略字母大小写<br>
	 *
	 * <pre>
	 ...
	 * @param str    需要校验的字符序列，允许为null
	 * @param suffix 待匹配的后缀字符串，允许为null
	 * @return 字符序列以后缀结尾（忽略大小写），或两者都为null时返回true，否则返回false
	 */
	...
	/**
	 * 判断字符序列是否以指定后缀结尾，可设置是否忽略大小写<br>
	 * @see java.lang.String#endsWith(String)
	 * @param str        需要校验的字符序列，允许为null
	 * @param suffix     待匹配的后缀字符串，允许为null
	 * @param ignoreCase true：忽略大小写比较；false：区分大小写比较
	 * @return 字符序列以后缀结尾，或两个参数都为null时返回true
	 */
	 ...
	 *
	 * @param sequence      待校验的字符序列，允许为null
	 * @param searchStrings 多个待匹配后缀，区分大小写；可变参数数组可为空，数组内元素允许为null
	 * @see StringUtils#endsWith(CharSequence, CharSequence)
	 * @return 待校验字符串不为空且匹配任意一个后缀时返回true；其余情况返回false
	 */
	 ...
	 * @return 处理后的字符串
	 */
	public static String replaceAllLineBreak(CharSequence input, String replacement) {
		if (isEmpty(input)) {
			return string(input);
		}
		if (replacement == null) {
			replacement = StringConstant.EMPTY;
		}
		StringBuilder sb = new StringBuilder(input.length());
		for (int i = 0; i < input.length(); i++) {
			char c = input.charAt(i);
			if (c == CharConstant.CR || c == CharConstant.LF) {
