...
public class DateUtil {
	...
	public static Date parseDate(String source) {
		return parseDate(source, ZoneUtil.getDefaultZoneId());
	}
	...
	public static Date parseDate(String source, String pattern) {
		return parseDate(source, pattern, ZoneUtil.getDefaultZoneId());
	}
	...
	public static String format(Date date) {
		return format(date, ISO8601_FORMAT);
	}
	...
	public static String format(Date date, String pattern) {
		return format(date, pattern, ZoneUtil.getDefaultZoneId());
	}
	 ...
	 */
	private static Date forceParseDate(final String source, ZoneId zoneId) throws ParseException {
		if (StringUtil.isBlank(source)) {
