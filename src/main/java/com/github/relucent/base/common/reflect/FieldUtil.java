...
public class FieldUtil {
	 ...
	 * @throws RuntimeException 没有找到匹配的字段，或者该字段不能访问
	 */
	public static Object readStaticField(final Class<?> clazz, final String fieldName) throws RuntimeException {
	 ...
	 */
	public static Object readStaticField(final Field field) throws RuntimeException {
		AssertUtil.notNull(field, "The field must not be null");
		MemberUtil.setAccessible(field);
