...
public class NumberUtil {
	...
	// ==============================Methods==========================================
	/**
	 * 对{@code BigDecimal}进行转换，使用银行家舍入法（Banker's Rounding）<br>
	 * 
	 * <pre>
	 * 核心规则：
	 * ├ 小于 5 → 舍去
	 * ├ 大于 5 → 进位
	 * └ 刚好等于 5 → 看保留位前一位是奇数还是偶数
	 * __├ 偶数 → 舍去
	 * __└ 奇数 → 进位
	 * </pre>
	 * 
	 ...
	 * @param roundingMode 舍入模式：数值运算的舍入行为，如果为null，则使用银行家舍入法（HALF_EVEN）
	 * @return 转换后的结果{@code BigDecimal}
	 */
	...
	/**
	 * 将{@code Float}转换为{@code BigDecimal}，使用银行家舍入法（Banker's Rounding）<br>
	 * 
	 * <pre>
	 * 核心规则：
	 * ├ 小于 5 → 舍去
	...
	/**
	 * 将{@code Double}转换为{@code BigDecimal}，使用银行家舍入法（Banker's Rounding）<br>
	 * 
	 * <pre>
	 * 核心规则：
	 * ├ 小于 5 → 舍去
	...
	/**
	 * 将{@code String}转换为{@code BigDecimal}，使用银行家舍入法（HALF_EVEN）保留两位小数
