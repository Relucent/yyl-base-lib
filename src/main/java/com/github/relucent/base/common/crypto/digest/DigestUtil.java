...
public class DigestUtil {
     ...
     * @return 数据摘要
     */
    public static byte[] digest(final MessageDigestAlgorithm algorithm, final byte[] input) {
     ...
     * @return 数据摘要
     */
    public static byte[] digest(final MessageDigestAlgorithm algorithm, final String input) {
     ...
     */
    public static String digestHex(final MessageDigestAlgorithm algorithm, final byte[] input) {
     ...
     * @return 数据摘要（16进制字符串表示）
     */
    public static String digestHex(final MessageDigestAlgorithm algorithm, final String input) {
    ...
    public static byte[] md5(byte[] input) {
        return digest(MessageDigestAlgorithm.MD5, input);
    }
    ...
    public static String md5Hex(String input) {
        return digestHex(MessageDigestAlgorithm.MD5, input);
    }
    ...
    public static byte[] sha256(byte[] input) {
        return digest(MessageDigestAlgorithm.SHA_256, input);
    }
    ...
    public static String sha256Hex(byte[] input) {
        return digestHex(MessageDigestAlgorithm.SHA_256, input);
    }
    ...
    public static byte[] sm3(byte[] input) {
        return digest(MessageDigestAlgorithm.SM3, input);
    }
    ...
    public static String sm3Hex(String input) {
        return digestHex(MessageDigestAlgorithm.SM3, input);
    }
