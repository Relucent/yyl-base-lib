 ...
 * <table cellspacing="8">
 * <caption>Cron Expression</caption>
 * <tr>
 ...
 * does NOT mean every 6th month, please note that subtlety. <br>
 ...
 * calendar month. <i>When using the 'L' option, it is important not to specify lists, or ranges of values, as you'll get confusing/unexpected results.</i> <br>
 ...
 * the day-of-month is a single day, not a range or list of days. <br>
 ...
 * in the month, then no firing will occur that month. If the '#' character is used, there can only be one expression in the day-of-week field (&quot;3#1,6#3&quot; is not valid, since there are two expressions). <br>
